...
{
    public partial class syncedissuesdbfunctions : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"
                drop function TableNameFromRepoKey(text);
                drop function CreateIssueSyncTable(text);
                drop function InsertIntoIssueSyncTable(text, int, int, text, text, text, uuid);
                drop function SwapIssueSyncTable(text);
                drop function CreateIssueTable(text);
                drop function InsertIntoIssueTable(text, int, int, text, text, text, uuid);
                drop function GetIssue(text, int);
                drop function GetIssues(text);
                drop function SearchIssues(text, text, int);
            ");
        }
    }
}
